#Faça um programa que leia um número N e gere um arquivo com N nomes e idades aleatórios:
...
#	Todos os dados podem ser gerados no próprio código sem a necessidade de fazer a leitura por meio de um arquivo.
